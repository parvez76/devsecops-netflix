...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/parvez76/devsecops-netflix.git
    ```
...
1. **Cleanup AWS EKS and EC2 Instances:**
    - Terminate AWS EKS clusters and EC2 instances that are no longer needed.
